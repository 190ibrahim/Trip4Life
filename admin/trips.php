        ...
        <div class="col-md-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <h3>Trips
                        <a href="add_trip.php" class="btn btn-primary float-end mx-2"> Add Trip </a>
                        <a href="index.php?unactivate_all=true" class="btn btn-primary float-end mx-2">Unactivate
                            All</a>
                        <a href="index.php?activate_all=true" class="btn btn-primary float-end mx-2">Activate All</a>
